            ...
            <nav id="sidebar">
               <div class="sidebar_blog_1">
                  <div class="sidebar-header">
                     <div class="logo_section">
                        <a href="index.php"><img class="logo_icon img-responsive" src="images/logo/uitm_icon.svg" alt="#" /></a>
                     </div>
                  </div>
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li class="active"><a href="settings.php"><i class="fa fa-cog yellow_color"></i> <span>Settings</span></a></li>
                     <li><a href="login.php"><i class="fa fa-sign-out blue2_color"></i> <span>Logout</span></a></li>
                  </ul>
               </div>
            </nav>
            <!-- end sidebar -->
                  ...
                  <div class="container-fluid">
                     ...
                     <div class="">
                        <div class="button_block">
                           <button type="button" class="btn cur-p btn-primary">Delete All Completed File</button>
                           <button type="button" class="btn cur-p btn-primary">Change Password</button>
                        </div>
                     </div>
                  </div>
                  <!-- footer -->
